...
public class MainActivity extends AppCompatActivity {
        ...
        db.collection("users")
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        // Lanjutkan inisialisasi activity
                        initializeActivity(currentUser);
                    } else {
    ...
    private void initializeActivity(FirebaseUser currentUser) {
        setContentView(R.layout.activity_main);

        // Notification dan service
        createNotificationChannel();
        checkNotificationPermission();
        startFirestoreListenerService();
    ...
    private void handleUserNotFound() {
        new AlertDialog.Builder(this)
                .setTitle("Kesalahan Akun")
                .setMessage("Akun Anda tidak ditemukan dalam sistem.")
